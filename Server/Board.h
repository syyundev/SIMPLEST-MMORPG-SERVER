...
public:
	...
	static constexpr short			SECTOR_SIZE = 20;
...
public:
	...
	std::unordered_set<int> GetNeighborSectorList(const Pos pos, const int viewRange = VIEW_RANGE);
	bool CanSee(const Pos from, const Pos to, const int viewRange = VIEW_RANGE);
};
